...
import com.android.bjl.adapter.MyJobWantedAdapter;
...
public class MyJobWantedListActivity extends BaseActivity {
    String title;
    ...
    XListView xListView;
    TextView tvNone;
    ArrayList<JobWantedBean> beans = new ArrayList<>();
    MyJobWantedAdapter adapter;
    ...
    private void initdata() {
        ...
        if (type==1){
            ...
            showTitleLeftTvAndImgAndRightTv(title, "返回", R.mipmap.back, "我要求职", new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    finish();
                }
                ...
                public void onClick(View view) {
                    startActivityForResult(MyJobWantedActivity.class, 100);
                }
            });
        }
    ...
    AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Intent intent =new Intent(MyJobWantedListActivity.this, MyJobWantedIndexActivity.class);
    ...
    XListView.IXListViewListener ixListViewListener = new XListView.IXListViewListener() {
        ...
        public void onLoadMore() {
            if (page >= pages) {
                MyToastUtil.showMEssage(MyJobWantedListActivity.this,getString(R.string.no_data_order));
    ...
    public void getDataList() {
        ...
        map.put("page", page+"");
        map.put("userId", "");
//        map.put("userId", PrefUtils.getString(MyJobWantedListActivity.this, "userId", ""));
        new HttpCommon(MyJobWantedListActivity.this, callBack).post(map, Constant.JOBWANTEDINFO, 1);
    }
    ...
    HttpEventCallBack callBack = new HttpEventCallBack() {
        ...
        public void onHttpSuccess(int requestId, Object content) {
            ...
            try {
                ...
                if (jsonObject.getString("code").equals("00")) {
                    switch (requestId) {
                        case 1:
                         final   JSONObject object =jsonObject.getJSONObject("jobWantedInfojson");
                            ...
                            if (page == 0) {
                                 ...
                                 */
                                beans.clear();
                                beans= GsonUtils.jsonToArrayList(data.toString(),JobWantedBean.class);
                                adapter = new MyJobWantedAdapter(MyJobWantedListActivity.this, beans);
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                              ...
                              ArrayList<JobWantedBean>  beans1= GsonUtils.jsonToArrayList(data.toString(),JobWantedBean.class);
                              beans.addAll(beans1);
                                    adapter = new MyJobWantedAdapter(MyJobWantedListActivity.this, beans);
                                    runOnUiThread(new Runnable() {
                                        @Override
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                MyToastUtil.showMEssage(MyJobWantedListActivity.this, jsonObject.getString("desc"));
        ...
        public void onHttpFail(int requestId, HttpRetId httpStatus, String msg) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    MyToastUtil.showMEssage(MyJobWantedListActivity.this, "数据请求失败");
