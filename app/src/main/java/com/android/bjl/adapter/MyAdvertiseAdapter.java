...
public class MyAdvertiseAdapter extends BaseAdapter {
    ...
    private ArrayList<AdvertiseBean> beans;

    public MyAdvertiseAdapter(Context context, ArrayList<AdvertiseBean> beans) {
    ...
    public void setData(ArrayList<AdvertiseBean> mList) {
        this.beans = mList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AdvertiseBean bean = getItem(position);
