package com.android.bjl.widget;
...
public class ClearEditText extends EditText implements View.OnFocusChangeListener,
    ...
    public void setReadOnly(Boolean isRead){
        this.setCursorVisible(!isRead);
        this.setFocusable(!isRead);
        this.setFocusableInTouchMode(!isRead);
        setClearIconVisible(!isRead);
    }
}
